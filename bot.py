...
# Support Group: @tellyfun4u 
# Bots Channel: @tellyfun4u
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/tellyfun4u"), InlineKeyboardButton("Support Group", url="https://t.me/joinchat/TY1u4q_jX_hlMjQ1 ")], [InlineKeyboardButton("Bots Channel", url="https://t.me/joinchat/08FCrdh1fRYwM2U1")]]),
			disable_web_page_preview=True
		)
